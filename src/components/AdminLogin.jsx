    ...
    <div className="min-h-[100dvh] flex items-center justify-center relative overflow-hidden bg-slate-900">
      ...
      <div className="w-full max-w-md p-8 bg-emerald-900/85 backdrop-blur-2xl rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-emerald-500/30 relative z-10 animate-slide-up mx-4">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-[0_10px_25px_rgba(0,0,0,0.3)] border-4 border-emerald-400 mb-6 relative">
             ...
             />
             <div className="absolute -bottom-2 bg-amber-400 text-emerald-950 text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-full shadow-md border-2 border-white">
                 Calasiao LGU
             </div>
          </div>
        ...
        <form onSubmit={handleLogin}>
          <div className="space-y-4">
            <div className="relative group">
              ...
              <input 
                type="text" 
                required
                className="w-full pl-11 pr-4 py-3.5 bg-emerald-950/60 border border-emerald-700/50 rounded-xl outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-400/30 transition-all text-white font-bold tracking-widest text-sm placeholder-emerald-600/60"
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className={`w-full font-black text-base py-3.5 rounded-xl shadow-xl transition-all mt-6 flex justify-center items-center relative overflow-hidden ${isLoading ? 'bg-emerald-800 text-emerald-400 cursor-not-allowed' : 'bg-amber-400 text-emerald-950 hover:bg-amber-300 active:scale-95 hover:shadow-amber-500/20'}`}
          >
      ...
      {showForgot && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 animate-fade-in">
          <div className="absolute inset-0 bg-emerald-950/80 backdrop-blur-sm" onClick={() => setShowForgot(false)}></div>
          <div className="bg-emerald-900 border border-emerald-500/30 rounded-3xl shadow-2xl w-full max-w-sm z-10 p-6 animate-slide-up relative">
            ...
            <div className="w-14 h-14 bg-emerald-950 text-amber-400 rounded-full flex items-center justify-center mb-4 mx-auto shadow-inner border border-emerald-700/50">
            ...
            <form onSubmit={handleForgotPassword} className="space-y-5">
               <div className="relative group">
                  ...
                  <input 
                    type="email" 
                    required
                    className="w-full pl-11 pr-4 py-3.5 bg-emerald-950/60 border border-emerald-700/50 rounded-xl outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-400/30 transition-all text-white font-bold text-sm tracking-wide placeholder-emerald-600/60"
               ...
               <button type="submit" className="w-full bg-amber-400 text-emerald-950 font-black py-3.5 rounded-xl hover:bg-amber-300 active:scale-[0.98] transition-all shadow-lg">
                  Send Recovery Link
               </button>
            </form>
          </div>
